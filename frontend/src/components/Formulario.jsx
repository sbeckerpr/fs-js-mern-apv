...
const Formulario = () => {
  ...
  return nuevaFecha.toLocaleDateString('en-CA', opciones)
  }
  ...
  return (
    <>
      ...
      <form className="bg-white py-10 px-5 mb-10 lg:mb-5 shadow-md rounded-md" onSubmit={handleSubmit}>
        ...
        <input type="submit" className="bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursos-pointer transition-colors" value={id ? 'Guardar Cambios' : 'Agregar Paciente'}/>
      </form>
