        ...
        <div className="flex justify-center">
          <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
            ...
            <form onSubmit={handleSubmit}>
              <div className="my-3">
                <label className="uppecase font-bold text-gray-600">Nombre</label>
              ...
              <div className="my-3">
                <label className="uppecase font-bold text-gray-600">Sitio Web</label>
              ...
              <div className="my-3">
                <label className="uppecase font-bold text-gray-600">Telefono</label>
              ...
              <div className="my-3">
                <label className="uppecase font-bold text-gray-600">Email</label>
