...
const CambiarPassword = () => {
  ...
  const handleSubmit = async e => {
    ...
    if(password.pwd_nuevo.length < 6){
      setAlerta({
        msg: 'El Password nuevo debe que tener minimo 6 caracteres',
        error: true
      })
      return;
    }
          ...
          <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
            ...
            <form onSubmit={handleSubmit}>
              <div className="my-3">
                ...
                <input type="password" className=" border bg-gray-50 w-full p-2 mt-5 rounded-lg" name="pwd_actual" placeholder="Escribe tu password actual" 
              ...
              <div className="my-3">
                ...
                <input type="password" className=" border bg-gray-50 w-full p-2 mt-5 rounded-lg" name="pwd_nuevo" placeholder="Escribe tu nuevo password"
                onChange={e => setPassword({ ...password, [e.target.name]: e.target.value})}/>
              </div>
